    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          BlocBuilder<CreateMatchCubit, CreateMatchState>(
              ...
              return AppButton(
                onPressed: () {
                  ...
                  if (startTime != null &&
                    ...
                    log(formatTimeOfDay(startTime!));
                    log(formatTimeOfDay(endTime!));
                    log(playersNum.toString());
